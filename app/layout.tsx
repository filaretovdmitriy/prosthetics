              ...
              <section className="approach">
                <div className="approach__container">
                  ...
                  <div className="approach__subtitle subtitle">
                    ...
                    <br /> консультации до получения{" "}
                    <span>готового изделия</span>
                  </div>
                  <div className="approach__cards">
                    ...
                    <div className="approach__card">
                      ...
                      <p>
                        Мы поможем собрать <span>полный пакет документов</span>{" "}
                        для подачи в органы ОСФР
                      </p>
                    </div>
                    <div className="approach__card">
                      <div className="approach__image">
                      ...
                      <p>
                        <span>Иногородних клиентов</span> встречаем в аэропорту
                        или на железнодорожном/автовокзале, поможем с жильем
                      </p>
                    </div>
                    <div className="approach__card">
                      <div className="approach__image">
                      ...
                      <p>
                        Мы непрерывно работаем над{" "}
                        <span>повышением качества</span> услуг
                      </p>
                    </div>
                    <div className="approach__card">
                      <div className="approach__image">
                      ...
                      <p>
                        ...
                        <span>профессионального роста</span> как рядовых
                        сотрудников, так и узких специалистов
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="experience__container">
                  ...
                  <div className="experience__cards">
                    ...
                    <div className="experience__card">
                      ...
                      <p>
                        <span>Следим</span> за новейшими тенденциями в
                        ортезировании и протезировании
                      </p>
                    </div>
                    <div className="experience__card">
                      <div className="experience__icon">
                  ...
                  <div className="experience__items">
                    <div className="experience__item">
                      <b>2004</b>
                      <p>
                        Основатель медицинского центра Сколиолоджик.ру привез в
                        Россию первый корсет Шено и создал первое производство
                        корсетов Шено. Поэтому у нас{" "}
                        <span>самый большой опыт по лечению сколиозов</span> в
                        России. Наши врачи сделали уже <span>более 30 000</span>{" "}
                        корсетов, которые победили <span> более 10 000</span>{" "}
                        сколиозов.
                      </p>
                    </div>
                    <div className="experience__item">
                      ...
                      <p>
                        ...
                        <span>Развиваем</span> направление ортопедических
                        изделий при ДЦП и других заболеваниях.{" "}
                        <span>Изобретаем и производим</span> собственные шарниры
                        для аппаратов на нижние конечности и туловище.
                      </p>
                    </div>
                    <div className="experience__item">
                      <b>2013</b>
                      <p>
                        ...
                        <span>Разработали</span> силиконовые культеприемные
                        гильзы и оборудование для их создания.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <form action="#" className="form">
              <div className="form__container">
                ...
                <div className="form__subtitle subtitle">
                  Вы получите подробную консультацию по интересующим вас
                  вопросам
                </div>
                ...
                <div className="work__container">
                  ...
                  <div className="work__card">
                    ...
                    <div className="work__content">
                      <span>Мы производим</span> индивидуальные ортопедические
                      изделия для реабилитации взрослых и детей с различными
                      заболеваниями позвоночника и нервной системы.
                    </div>
                  </div>
                  <div className="work__card">
                    <div className="work__image">
                    ...
                    <div className="work__content">
                      <span>Мы занимаемся лечением</span> сколиоза, кифоза,
                      лордоза. Наш профиль – лечение сколиоза с помощью корсета
                      по типу Шено и гимнастики по методу Катарины Шрот.
                      Сочетание корсета и гимнастики – единственный в мире
                      доказанный метод лечения сколиоза.
                    </div>
                  </div>
            ...
            <div className="how">
              <div className="how__container">
                ...
                <ul>
                  ...
                  <li>
                    в результате чего корсеты, протезы, аппараты и туторы точны
                    до миллиметра!
                  </li>
                </ul>
              </div>
